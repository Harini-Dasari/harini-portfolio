export const portfolioData = {
  personal: {
    ...
    linkedin: "https://www.linkedin.com/in/dasariharini/",
  },
  about: {
    paragraphs: [
  ...
  education: [
    ...
    {
      institution: "Rajiv Gandhi University of Knowledge Technologies (RGUKT), RK Valley",
      degree: "Pre-University Program (MPC)",
      duration: "2021 – 2023",
      gpa: "9.8 / 10"
    }
  ],
  ...
  contact: {
    cta: "I am always excited to collaborate on innovative projects, research opportunities, AI solutions, and impactful technology initiatives. Let's build something meaningful together.",
  }
};
